...
public class PlayerController1 : MonoBehaviour // Moves the players hands and allows the player to climb
{
    ...
    private float handRadius = 0.22f; // Radius of the hands overlap circle
    private float bodyRadius = 0.33f; // Radius of the ground check
